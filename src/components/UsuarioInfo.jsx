...
function UsuarioInfo(props){
    ...
    return (
        <section id="userAllInfoSection">
            <div className="telaHeader">
                <h2>Usuário</h2>
            </div>

                <div className="contentRow">
                    <h2 className="userInfoData usuarioNome">{props.usuarioCarregado.nome}</h2>
                </div>
            
                <div className="usuarioDados">
                    <div className="usuarioGeralInfo">
                        <div className="usuarioDevInfo contentRow ">
                        {/* Id */}
                        <div className="userInfoDiv">ID
                            <p className="userInfoData">
                                {props.usuarioCarregado.id}</p>
                            </div>
                            {/* aluno/candidato */}
                        ...
                        <div className="contentRow">
                            ...
                            <p className="userInfoData">{props.usuarioCarregado.telefone}</p>
